@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
        ...
        <div class="flex justify-between flex-1 min-[835px]:hidden">
        ...
        <div class="hidden min-[835px]:flex-1 min-[835px]:flex min-[835px]:items-center min-[835px]:justify-between">
            <div>
