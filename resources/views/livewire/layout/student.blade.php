...
<!-- ========== HEADER ========== -->
<header class="flex sticky flex-wrap sm:justify-start sm:flex-nowrap bg-white dark:bg-gray-800 antialiased shadow-lg z-50 w-full text-sm py-2 sm:py-0">
    <!--===Navbar section===-->
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 flex items-center justify-between sm:px-6 lg:px-8"
         aria-label="Global">
        <div class="flex items-center justify-between w-full">
            <a class="flex-none text-xl font-semibold dark:text-white" href="./dashboard-student.html"
            ...
            <div class="flex  sm:items-center sm:justify-end py-2 md:py-0 sm:ps-7">
                ...
                <div class="flex items-center gap-x-2 font-semibold text-gray-500 hover:text-green-600  py-2 sm:py-0 sm:my-6 sm:ps-6 dark:text-neutral-400 dark:hover:text-green-500">
                        ...
                        <div id="selectThemeDropdown"
                            ...
                            <div class="hs-dropdown [--strategy:static] sm:[--strategy:absolute] [--adaptive:none] sm:[--trigger:hover] relative">
                                ...
                                <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 sm:w-48 hidden z-10 sm:mt-2 bg-white sm:shadow-md rounded-lg p-2 dark:bg-neutral-800 sm:dark:border dark:border-neutral-700 dark:divide-neutral-700 before:absolute sm:border before:-end-5 before:top-0 before:h-full before:w-5 !mx-[10px] top-0 end-full">
                                    <button class="flex rounded-[10px] p-1 hover:bg-gray-100 dark:hover:bg-gray-700 w-full">
                ...
                <div class="m-1 hs-dropdown relative inline-flex">
                    <button id="hs-dropdown-hover-event" type="button"
                        ...
                        <span class="flex absolute top-0 end-0 -mt-2 -me-2">
                            ...
                            <span class="relative inline-flex text-xs bg-green-500 text-white rounded-full py-0.5 px-1.5">
                              9+
                            </span>
                            </span>
                    </button>
                ...
                <div class="hs-dropdown relative inline-flex">
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] z-[1] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700"
                        ...
                        <div class="mt-2 py-2 first:pt-0 last:pb-0">
                            ...
                            <form wire:submit.prevent="logout"
                                ...
                                <button type="submit" class="flex font-semibold rounded-lg border border-transparent text-gray-800 gap-x-3.5 w-full py-2 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor" width="24"
                                         height="24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
