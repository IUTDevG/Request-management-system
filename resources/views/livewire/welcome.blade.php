    ...
    <header
        ...
        <div class="max-w-[85rem] mx-auto w-full px-4 sm:px-6 lg:px-8 mt-2 flex items-center justify-end">
            <div class="flex items-center justify-end w-full py-2 gap-x-5 sm:pt-2 sm:pb-0">
                ...
                <a href="{{ \App\Services\UserRedirectService::getRedirectUrl()}}" wire:navigate.hover
        ...
        <nav
            ...
            <div class="flex items-center justify-between">
                <a class="flex items-center justify-center" href="{{ route('home') }}" wire:navigate.hover
                    ...
                    <div class="divide-y divide-gray-200 hs-accordion-group dark:divide-neutral-700">
                        <div class="pb-3 hs-accordion active"
                            ...
                            <button
                                ...
                                <!-- Icônes d'accordéon -->
                                <svg
                                    class="flex-shrink-0 block text-gray-600 hs-accordion-active:hidden size-5 group-hover:text-gray-500 dark:text-neutral-400"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>
                                </svg>
                                <svg
                                    class="flex-shrink-0 hidden text-gray-600 hs-accordion-active:block size-5 group-hover:text-gray-500 dark:text-neutral-400"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
